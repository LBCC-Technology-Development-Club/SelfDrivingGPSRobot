...
//@note: The code in this file is based on the work of iforce2d: https://www.youtube.com/watch?v=TwhCX0c8Xe0
...
const char UBLOX_INIT[] PROGMEM = {
  ...
  //then switch on the desired one
...
void setupGPS()
{
  //@brief: send configuration data in UBX protocol
...
void calcChecksum(unsigned char* CK) {
  //@brief: calculate the checksum over the posllh data
  memset(CK, 0, 2);
